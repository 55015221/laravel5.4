...
class JavaComm
{
    ...
    private static $serverUrl = array(
        ...
        'mobileMultiSignUrl' => '/tech-sdkwrapper/timevale/sign/mobileMultiSign',
    ...
    public function init($config)
    {
        ...
        if ((int)$errCode !== 0) {
            throw new \Exception('本地java服务初始化失败 - ' . Util::encodePath(Util::jsonEncode($res)));
        }
    }
    ...
    {
        $authUrl = rtrim($this->serverName, '/') . self::$serverUrl[$urlKey];
