...
use tech\result\EvidenceResult;
...
class eSign
{
     ...
     * 发送渠道
     */
    const CHANNEL = 'phptechsdk2.0.004';
    ...
    {
        self::$_CONFIG = $config;
        $incFile = '/tmp/eSign_inc_lxb.dat';
        $this->javaComm = new javaComm(self::$_CONFIG['java_server']);
        $this->recorder = new Recorder($incFile);
        $needInit = file_exists($incFile);
        $this->init(!$needInit);
    }
